...
class BreakGlassActivationError(RuntimeError):
    ...
    Kept separate from :class:`~fdai.core.rbac.enforcer.AuthorizationError`
...
class GroupMapping:
    ...
    def from_config(
        ...
        return cls(
            reader_group_id=_pick("readers", "FDAI_RBAC_READERS_GROUP_ID"),
            contributor_group_id=_pick("contributors", "FDAI_RBAC_CONTRIBUTORS_GROUP_ID"),
            approver_group_id=_pick("approvers", "FDAI_RBAC_APPROVERS_GROUP_ID"),
            owner_group_id=_pick("owners", "FDAI_RBAC_OWNERS_GROUP_ID"),
            break_glass_group_id=_pick("break_glass", "FDAI_RBAC_BREAK_GLASS_GROUP_ID"),
        )
