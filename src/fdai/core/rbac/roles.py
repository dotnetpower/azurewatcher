...
- It is never auto-activated by claims alone. The
  :class:`~fdai.core.rbac.resolver.RoleResolver` drops
  ...
  :class:`~fdai.core.rbac.resolver.BreakGlassActivation`
...
class Capability(StrEnum):
    ...
    :func:`fdai.core.rbac.enforcer.RoleEnforcer.no_self_approval`
