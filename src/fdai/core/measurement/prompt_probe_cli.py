...
.. code-block:: shell
    ...
    FDAI_CATALOG_ROOT=/path/to/rule-catalog \\
...
from fdai.core.measurement.prompt_probe_emit import emit_kpi_rows
from fdai.core.measurement.prompt_probe_loader import load_scenarios
...
_LOGGER = logging.getLogger("fdai.core.measurement.prompt_probe_cli")
_ENV_CATALOG_ROOT: Final[str] = "FDAI_CATALOG_ROOT"
...
def resolve_catalog_root() -> Path:
    ...
    Discovery order:
      1. ``FDAI_CATALOG_ROOT`` env var, if it points at a real dir.
