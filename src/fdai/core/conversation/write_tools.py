...
Distinct from :mod:`fdai.core.conversation.system_tools` (read-only
...
class SimulateChangeTool:
    ...
    :class:`~fdai.core.conversation.system_tools.QueryAuditTool`.
...
class AuditWriter:
    ...
    :class:`~fdai.core.conversation.tools.SystemConsoleTool`); the
    ...
    :class:`~fdai.core.conversation.system_tools.QueryInventoryTool`
    already uses.
...
class ActivateBreakGlassTool:
    ...
    (:mod:`fdai.core.rbac.resolver`) grants the role for the
    session.
    """
