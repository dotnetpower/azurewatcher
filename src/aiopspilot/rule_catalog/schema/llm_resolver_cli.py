...
.. code-block:: bash
    ...
    python -m aiopspilot.rule_catalog.schema.llm_resolver_cli \\
...
from aiopspilot.rule_catalog.schema.llm_registry import load_llm_registry_from_yaml
