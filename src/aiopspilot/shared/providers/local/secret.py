...
from aiopspilot.shared.providers.secret_provider import SecretNotFoundError


class EnvSecretProvider:
    """Fallback secret provider used in dev + tests.

    The prefix (default ``AIOPSPILOT_SECRET_``) narrows the env-var
