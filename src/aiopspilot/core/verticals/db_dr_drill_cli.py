...
The CLI composes a
:class:`~aiopspilot.core.verticals.db_dr_verifier.DbDrVerifier` with
...
- ``AIOPSPILOT_DR_DRILL_SOURCE_SERVER_ARM_ID`` (required) — ARM id of
...
from aiopspilot.core.verticals.db_dr_verifier import DbDrOutcome, DbDrVerdict
from aiopspilot.shared.providers.db_dr import DbRestoreConfig

_LOGGER = logging.getLogger("aiopspilot.core.verticals.db_dr_drill_cli")


_ENV_SOURCE = "AIOPSPILOT_DR_DRILL_SOURCE_SERVER_ARM_ID"
_ENV_LOCATION = "AIOPSPILOT_DR_DRILL_TARGET_LOCATION"
_ENV_RG_PREFIX = "AIOPSPILOT_DR_DRILL_TARGET_RG_PREFIX"
_ENV_SERVER_PREFIX = "AIOPSPILOT_DR_DRILL_TARGET_SERVER_PREFIX"
_ENV_PITR_OFFSET = "AIOPSPILOT_DR_DRILL_PITR_OFFSET_MINUTES"
_ENV_DRY_RUN = "AIOPSPILOT_DR_DRILL_DRY_RUN"

_DEFAULT_RG_PREFIX = "rg-aiopspilot-dr-drill"
...
async def _amain() -> int:
    ...
    # this CLI to import :mod:`aiopspilot.composition`, bind the
