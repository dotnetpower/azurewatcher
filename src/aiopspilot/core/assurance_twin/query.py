...
from aiopspilot.shared.providers.projection import ResourceRef, ScratchProjection
...
def execute_query(
    ...
    *,
    ...
    :class:`~aiopspilot.core.assurance_twin.InMemoryProjection` can
    ...
    if resources is None:
        ...
        from aiopspilot.core.assurance_twin.projection import InMemoryProjection
