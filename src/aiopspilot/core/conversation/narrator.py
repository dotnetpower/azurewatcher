...
:class:`~aiopspilot.core.conversation.coordinator.ConversationCoordinator`
...
(see :mod:`aiopspilot.delivery.azure.llm.narrator`) - `core/` MUST
...
class ToolSchema:
    ...
    :func:`~aiopspilot.core.conversation.coordinator._VERB_PATTERNS`
...
class Narrator(Protocol):
    ...
    :class:`~aiopspilot.core.conversation.tools.AbstainResult`).
...
def default_tool_schemas() -> tuple[ToolSchema, ...]:
    ...
    Mirrors the shipped :func:`~aiopspilot.core.conversation.coordinator._VERB_PATTERNS`
...
def format_prompt_tool_list(tools: Sequence[ToolSchema], principal_role: str) -> str:
    ...
    :class:`~aiopspilot.core.rbac.roles.Role`.
    """
