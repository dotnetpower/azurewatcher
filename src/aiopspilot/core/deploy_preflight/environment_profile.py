...
- **CSP-neutral, no I/O**: only :mod:`shared.contracts.models` shapes
  ...
  :class:`~aiopspilot.shared.providers.inventory.Inventory` in the
...
class DeploymentEnvironmentProfileCache:
    ...
    :class:`~aiopspilot.shared.providers.inventory.Inventory` delta
...
def apply_inventory_delta(
    ...
    *,
    ...
    :meth:`~aiopspilot.shared.providers.inventory.Inventory.delta`
