...
translation_source_sha: 076fc440037d6535c8cebe32672abd250eb50f0f
...
- **지출 이상 감지.** 예상 베이스라인에서 벗어난 비용 신호는 발견된 문제를 생성합니다.
...
4. **적용 모드로 승격.** 승격 기준을 충족하는 정확도가 측정된 뒤에만 액션을 자율 실행할
  수 있습니다.
...
- [리스크 티어](../concepts/risk-tiers-ko.md) - 비용 변경이 auto, 사람 승인, deny로 라우팅되는 방식.
