...
- `governance.grant-exemption` - create a time-boxed exemption
  ([rule-governance.md](../rules-and-detection/rule-governance.md)). Existing exemptions are
...
| `side_effect_class` | [operator-console.md § 3.4](../interfaces/operator-console.md#34-tool-discovery-contract) | read / simulate / approve / execute / breakglass | *what the console tool does* |
...
- Time-boxed; auto-expiry ships with the existing exemption workflow
  ([rule-governance.md](../rules-and-detection/rule-governance.md)).
...
- [operator-console.md](../interfaces/operator-console.md) - operator-request
  trigger surface; tool schema is `argument_schema`.
- [rule-governance.md](../rules-and-detection/rule-governance.md) - how ActionType promotions,
...
- [security-and-identity.md](../architecture/security-and-identity.md) - safety
