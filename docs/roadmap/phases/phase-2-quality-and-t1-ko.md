...
## LLM Quality Gate (T2 - [llm-strategy-ko.md](../architecture/llm-strategy-ko.md) 참조)

T2 입력은 **untrusted** ([security-and-identity-ko.md](../architecture/security-and-identity-ko.md));
