...
translation_source_sha: 4bfca4fb92142b8844e94774315ac72d2e8c4698
...
> AND), exclusions, `Scope.covers`, 그리고 `most_specific` 우선순위 헬퍼. 규칙을 scope 에 effect
> 로 바인딩하는 `Assignment` 와 `RuleSet` artifact 는 후속 작업.
