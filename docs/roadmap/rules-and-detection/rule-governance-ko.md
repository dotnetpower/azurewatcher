...
translation_source_sha: aa0bc301f45a864784559e16ce88d518ad450c75
...
> `validate_effect_transition` (enforce effect 로의 상향은 별도 promotion 승인 필요). 이 타입들을
> 소비하는 `Scope`, `Assignment`, `RuleSet` artifact 는 후속 작업.
