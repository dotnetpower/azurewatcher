...
| 각 워크플로우가 소비하는 ActionType 스키마 | [action-ontology.md](action-ontology-ko.md) |
| 각 verdict 가 대응하는 risk classification | [risk-classification.md](risk-classification-ko.md) |
