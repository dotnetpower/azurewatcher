...
translation_source_sha: 4c181891e0d2af129a7436e9e967949a075278e6
...
- 오퍼레이터 콘솔 ([operator-console.md](../interfaces/operator-console-ko.md)) 은 §7.3 과
...
- 룰-카탈로그와 executor ([action-ontology.md](../decisioning/action-ontology-ko.md),
  [execution-model.md](../decisioning/execution-model-ko.md)) 는 §8 을 읽고 각 ActionType 을
