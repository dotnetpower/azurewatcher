...
translation_source_sha: e84882c4ed9c2f6ae43ee0e94b2094d14110457d
...
전체 표** 는
[dev-and-deploy-parity-ko.md § 배포자-스코프 LLM 프로비저닝](dev-and-deploy-parity-ko.md#배포자-스코프-llm-프로비저닝)
...
`routes_to`) 는 risk-gate 가 [risk-classification-ko.md](risk-classification-ko.md) 의 3-값
