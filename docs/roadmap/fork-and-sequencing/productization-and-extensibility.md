...
| P1-25 | Model endpoint discovery and Settings inventory | P1-23 | Partial: deterministic source aggregation, domain-separated signed GPU registration, sanitized read-only Settings inventory, and runtime health reuse pass; concrete ARM and APIM management-plane collectors remain exit gates |
