...
translation_source_sha: 6ed56fba44d8203ae5cad2a27976f079d2cbe498
...
2. Server-owned index를 초기화하거나 검색하기 전에 behavior subject와 behavior-question intent를
  ...
  Incident 정의는 concept query로 유지합니다. Retrieval floor보다 score가 낮을 때도 다음
  authority로 넘깁니다.
...
PostgreSQL/in-memory top-hit 및 exact-class parity를 검사합니다. Frozen architecture holdout paraphrase 20개는 routing,
