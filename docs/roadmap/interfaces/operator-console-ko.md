...
translation_source_sha: 59ad9d3784a18d0b536980f4e3b3b264f24568cf
...
agent SSE reader는 keepalive comment를 포함해 45초 동안 byte가 없으면 연결을 cancel하고 기존 bounded
reconnect path로 이동합니다. Canvas
