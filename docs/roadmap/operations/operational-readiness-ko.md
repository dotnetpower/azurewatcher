...
|-----------|-------------------|-----------------------------|
| [deployment-preflight](../deployment/deployment-preflight-ko.md) | 하나의 배포: 이 변경이 대상 scope 에 착지할 수 있는가 | 단일 `terraform apply` / remediation PR 로 한정, 누적 posture 아님 |
...
[rule-governance](../rules-and-detection/rule-governance-ko.md) override 가 사용하는 동일한 scope
...
gate 됩니다 - [ActionType 계약](../architecture/llm-strategy-ko.md) 과 preflight 프로브가 적용하는
동일한 promotion 규율입니다.
...
([risk-classification.md](../decisioning/risk-classification-ko.md)). environment 분류기와 그것이
consume 하는 promotion 순서는
[risk-classification.md § Environment Promotion](../decisioning/risk-classification-ko.md#환경-승격environment-promotion-핸드오프-대상)
...
| 게이트가 consume 하는 environment 모델 | [risk-classification.md § Environment Promotion](../decisioning/risk-classification-ko.md#환경-승격environment-promotion-핸드오프-대상) |
| 제안된 각 fix 가 resolve 하는 risk classification | [risk-classification.md](../decisioning/risk-classification-ko.md) |
