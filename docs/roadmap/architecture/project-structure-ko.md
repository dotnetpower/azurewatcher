...
translation_source_sha: 3909cc7a6a146a777bf07d341388b074d8b88ac8
...
│   │   ├── conversation/       # Operator console intent/tool 조정, exact-ref fallback이 있는 dynamically composed grounded narration, safe attachment metadata, per-turn isolation, durable delivery, adapter health 및 busy-input arbitration
