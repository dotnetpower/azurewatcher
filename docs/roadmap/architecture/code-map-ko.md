...
translation_source_sha: e64ee489296095e62a9ac335ec7928755da383ec
...
아래 표들은 48개의 core 서브시스템 디렉토리 (`tiers/*` 세 개 하위 디렉토리를
따로 세면 50행; 자매 문서 [project-structure.md](project-structure-ko.md)는
...
- **`src/fdai/core/`** = 헤드리스 컨트롤 플레인. UI 없음, 클라우드 SDK
  직접 import 없음. 48개 서브시스템 디렉토리 + 최상위 `ontology_explorer.py`
...
| persistence | durable LLM metering 및 report-signal projection을 포함한 Postgres + pgvector 스토어 | [src/fdai/delivery/persistence/](../../../src/fdai/delivery/persistence/) |
