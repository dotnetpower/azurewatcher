...
| background_task | Lease/CAS ownership, coalesced progress, 정직한 process-loss state, completion handoff를 사용하는 영구 detached 읽기 전용 session ([설계](../interfaces/background-task-sessions-ko.md)) | [src/fdai/core/background_task/](../../../src/fdai/core/background_task/) | [tests/core/background_task/](../../../tests/core/background_task/) |
| read_investigation | Exact-resource-first Azure read planning, normalized evidence, sequential-source aggregation을 사용하는 durable latency profile, direct/streamed/detached policy ([설계](../interfaces/azure-read-investigations-ko.md)) | [src/fdai/core/read_investigation/](../../../src/fdai/core/read_investigation/) 및 [src/fdai/shared/providers/read_investigation.py](../../../src/fdai/shared/providers/read_investigation.py) | [tests/core/read_investigation/](../../../tests/core/read_investigation/), [tests/delivery/azure/read_investigation/](../../../tests/delivery/azure/read_investigation/), focused read API/persistence test |
