...
| Subsystem | Responsibility | Source | Tests |
|-----------|----------------|--------|-------|
| conversation | NL turn -> one read-only tool call; explicit current-screen questions receive a bounded evidence walkthrough directive; model-generated Korean prose receives one evidence-placeholder-preserving quality review | [src/fdai/core/conversation/](../../../src/fdai/core/conversation/), [chat_prompt.py](../../../src/fdai/delivery/read_api/routes/chat_prompt.py), and [chat_answer_quality.py](../../../src/fdai/delivery/read_api/routes/chat_answer_quality.py) | [tests/core/conversation/](../../../tests/core/conversation/), [test_chat_prompt.py](../../../tests/delivery/read_api/test_chat_prompt.py), and [test_chat_answer_quality.py](../../../tests/delivery/read_api/test_chat_answer_quality.py) |
