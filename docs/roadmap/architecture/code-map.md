...
| Subsystem | Responsibility | Source | Tests |
|-----------|----------------|--------|-------|
| conversation | NL turn -> one read-only tool call; explicit current-screen questions receive a bounded evidence walkthrough directive | [src/fdai/core/conversation/](../../../src/fdai/core/conversation/) and [src/fdai/delivery/read_api/routes/chat_prompt.py](../../../src/fdai/delivery/read_api/routes/chat_prompt.py) | [tests/core/conversation/](../../../tests/core/conversation/) and [test_chat_prompt.py](../../../tests/delivery/read_api/test_chat_prompt.py) |
