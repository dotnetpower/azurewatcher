...
│   │   ├── conversation/       # operator-console intent/tool coordination, dynamically composed grounded narration with exact-ref fallback, safe attachment metadata, per-turn isolation, durable delivery, adapter health, and busy-input arbitration
