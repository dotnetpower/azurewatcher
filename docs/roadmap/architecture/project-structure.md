...
│   │   ├── conversation/       # operator-console intent/tool coordination, grounded result narration with exact-ref fallback, safe attachment metadata, per-turn isolation, durable delivery, adapter health, and busy-input arbitration
