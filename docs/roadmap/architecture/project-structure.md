...
│   │   ├── conversation/       # operator-console coordination, safe attachment metadata, exact refs, per-turn failure isolation, post-ingestion dedup, durable delivery, adapter health, and busy-input arbitration
