...
translation_source_sha: 646c99e5697c16e8137c6b94d8ec4440c4d11348
...
- 프로비저닝 리소스 - **최소 비용 효율 세트** (전체 인벤토리 + 티어 결정은
  ...
  인벤토리는 [csp-neutrality-ko.md](../architecture/csp-neutrality-ko.md) 의 다섯 개 와이어 수준 계약을 렌더링):
...
- [ ] Terraform-only vs Terraform + Bicep 분리 ([tech-stack-ko.md](../architecture/tech-stack-ko.md) 참조).
