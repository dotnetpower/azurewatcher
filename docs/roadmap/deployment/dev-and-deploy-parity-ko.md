...
| `rule-catalog/llm-registry.yaml` | [llm-strategy.md § Capability Preferences Registry](../architecture/llm-strategy-ko.md#capability-preferences-registry) 에 설계됨 | capability→family 선호 소스 없음 |
| Bootstrap resolver CLI | [llm-strategy.md § Bootstrap Provisioner](../architecture/llm-strategy-ko.md#bootstrap-provisioner) 에 설계됨 | 배포자 아이덴티티 + 리전 카탈로그 조회하는 게 없음 |
...
- [tech-stack.md § Local Development](../architecture/tech-stack-ko.md#local-development) 를 명시적으로
