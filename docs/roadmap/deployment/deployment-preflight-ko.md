...
- **컨트롤 플레인**: [executor](../architecture/project-structure-ko.md)가 remediation PR을 emit하기
...
[ActionType contract](../architecture/llm-strategy-ko.md)가 적용하는 것과 동일한 승격 규율입니다.
