...
#
# Usage:
#   scripts/tests-for-diff.sh                    # working tree vs HEAD
#   scripts/tests-for-diff.sh HEAD~5..HEAD       # commit range
#   scripts/tests-for-diff.sh --run              # also run pytest
#   scripts/tests-for-diff.sh --run HEAD~1..HEAD # combined
#
# Notes:
